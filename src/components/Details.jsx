...
import { fetchDetails, fetchtvDetails } from "./api/detailApi";
        ...
        >
          <div className="container">
            ...
            <div className="movie-detail-content">
              <p className="detail-subtitle">{person.title}</p>
              ...
              <div className="meta-wrapper">
                <div className="badge-wrapper">
                  <div className="badge badge-fill">{person.adult ? "18+" : "PG-13"}</div>
